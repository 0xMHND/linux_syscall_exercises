...
int main(int argc, char** argv){
  ...
  sentToThreads(sqrt(bound)+1,bound);
...
//}
//printf("\ncount = %lu   ",k);
//if(k!=203280221)printf(" should be 203280221... \n");
//else printf("\n");
//}
...
void compare(){
  ...
  printf("next prime is %u\n",Buff2);
  printf("double check count %u\n",h);
